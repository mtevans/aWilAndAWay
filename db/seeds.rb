...
Venue.create!(
  ...
  url: "http://res.cloudinary.com/dfld7chk4/image/upload/v1468891502/Children_Youth/mentor.png",
  lat: 37.820873,
  lng: -122.285055,
...
Venue.create!(
  ...
  address: "3433 Scott Street, San Francisco, CA 94123",
  url: "http://res.cloudinary.com/dfld7chk4/image/upload/v1468894986/ged-2_wg6bct.jpg",
  lat: 37.801627,
  lng: -122.441541,
  email: "NorthSideClinic@example.com",
  organizer_id: 3,
...
Venue.create!(
  ...
  url: "http://res.cloudinary.com/dfld7chk4/image/upload/v1468894984/Watch-the-wild_zha63h.jpg",
  lat: 37.761631,
  lng: -122.425202,
